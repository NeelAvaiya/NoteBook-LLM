...
import { createMemoryForUser, updateMemoryForUser, } from "../services/memory.services.js";
...
function parseCreateBody(body) {
    ...
    if (!parsed.success) {
        throw new ValidationError("Invalid memory", getZodFieldErrors(parsed.error));
    }
    return parsed.data;
}
